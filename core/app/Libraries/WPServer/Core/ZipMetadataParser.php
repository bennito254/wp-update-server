...
class ZipMetadataParser {
	...
	public function __construct($filename){
        ...
        $this->cache = new FileCache(WP_SERVER_DIRECTORY.'cache');
		$this->setMetadata();
	}
	...
	protected function extractMetadata(){
		...
		$this->packageInfo = ExtensionMeta::parsePackage($this->filename, true);
        log_message('critical', json_encode($this->packageInfo));
